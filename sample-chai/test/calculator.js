...
const calculator = require('../maths');
...
describe('basic mathematical operations', () => {
  ...
  describe('division', () => {
    ...
    it('should return NaN if the denominator is zero', () => {
      expect(calculator.divide(4, 0)).to.not.be.finite;;
      expect(calculator.divide(50, 0)).to.not.be.finite;
      expect(calculator.divide(-15, 0)).to.not.be.finite;;
    })
  })
})
